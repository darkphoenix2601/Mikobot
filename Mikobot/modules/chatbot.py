...
from Mikobot import BOT_ID, app, eor
from Mikobot.core.decorators.errors import capture_err
from Mikobot.utils.filter_groups import chatbot_group
import emoji
...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("app", "Aco")
        URL = f"https://api.affiliateplus.xyz/api/chatbot?message={test}&botname=@szMikobotBot&ownername=@supunma"
