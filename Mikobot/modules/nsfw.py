...
from Mikobot import  arq, app as pbot
from Mikobot.core.decorators.errors import capture_err
from pyrogram import filters
from pyrogram.types import Message
from Mikobot import eor, app
from Mikobot.core.decorators.errors import capture_err
...
#nsfwscan 
@pbot.on_message(filters.command(["nsfwscan", f"nsfwscan@szMikobotbot"]))
@capture_err
