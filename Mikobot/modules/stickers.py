...
from Mikobot import BOT_USERNAME, SUDOERS, USERBOT_PREFIX, app, app2, eor
from Mikobot.core.decorators.errors import capture_err
from Mikobot.utils.files import (get_document_from_file_id,
                             resize_file_to_sticker_size, upload_document)
from Mikobot.utils.stickerset import (add_sticker_to_set, create_sticker,
