...
from Mikobot import (BOT_USERNAME, MESSAGE_DUMP_CHAT, SUDOERS, USERBOT_ID,
...
from Mikobot.core.types import InlineQueryResultCachedDocument
from Mikobot.modules.info import get_chat_info, get_user_info
from Mikobot.utils.functions import test_speedtest
from Mikobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[Mikobot✨](https://github.com/szsupunma/sz-Mikobot-bot):**
**System Stats:**
**MainBot:** `{bot_state}`
