...
afilters = """
**AUTO FILTERS**
Mikobot Can filter content of a given channel automatically
...
1) Add @szMikobotbot to your channel
...
Mikobot will reply something else! can be used to create your own commands, 
if desired.
...
Mikobot's filters comes under **4** types.
